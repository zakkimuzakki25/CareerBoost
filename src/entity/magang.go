...
type Magang struct {
	...
	StatusMagangLong  string     `json:"status_magang_long" gorm:"type:VARCHAR(255);NOT NULL"`
	StatusMagangShort string     `json:"status_magang_short" gorm:"type:VARCHAR(255);NOT NULL"`
...
type MagangAdd struct {
	...
	Fee               float32   `json:"fee"`
	JangkaWaktu       string    `json:"jangka_waktu"`
	StatusMagangLong  string    `json:"status_magang_long"`
	StatusMagangShort string    `json:"status_magang_short"`
}
